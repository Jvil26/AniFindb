            ...
            <div className="carousel-item active">
              ...
              <div className="carousel-caption d-none d-md-block">
                ...
                <p className="lead">
                  <Link
                    exact
                    to={currentUser ? "/anime-list" : "/login"}
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-none d-md-block">
                ...
                <p className="lead">
                  <Link
                    exact
                    to={currentUser ? "/manga-list" : "/login"}
                    className="btn btn-lg btn-secondary fw-bold"
                  >
                    Discover Mangas
                  </Link>
            ...
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-none d-md-block">
                ...
                <p className="lead">
                  ...
                  search through and learn more about your favorite characters.
                </p>
                <p className="lead">
                  <Link
                    exact
                    to={currentUser ? "/character-list" : "/login"}
                    className="btn btn-lg btn-secondary fw-bold"
                  >
                    Discover Characters
                  </Link>
